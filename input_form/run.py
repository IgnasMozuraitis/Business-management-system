...
# app.debug = True
db = SQLAlchemy(app)
POSTGRES_URI = "postgres://kdskevvs:eeO3rxW0q9ZhCkMBz2VDsLIu3KBfSajV@rogue.db.elephantsql.com:5432/kdskevvs"
...
try:
    with connection:
        with connection.cursor() as cursor:
            cursor.execute(
                "CREATE TABLE transactions1 (user_name TEXT, email TEXT);"
                           )
